# Umsetzungsstand vom 10.09.2026
...
| Native Stores liegen getrennt in KV-Speichern | Gemeinsame SQLite-Dokumentdatenbank mit einmaligem Import |
...
Keine neuen Clientsecrets, keine zusätzliche Telemetrie, keine Übermittlung der Migration/Backups. SQL-Werte werden gebunden. Lokale Backups dienen der Migration und werden beim lokalen Reset einbezogen. Serverseitiger Coach, Benutzerisolation, Auth-Tokens, Cloud-Löschung und restliche Dependency-Befunde verhindern weiterhin eine Releasefreigabe.

## Architekturgrenze und nächster Schritt
SQLite ist auf Geräten tatsächlich eingebunden; der erste Schritt verwendet Store-Dokumente. Noch keine vollständig normalisierten Session-/Set-/Outbox-Tabellen, Benutzerpartition oder komplette Transaktionsabdeckung aller Aktionen. Nächster Schritt: Phase 3b mit granularen Repositories und Benutzergrenzen, parallel später Geräteabnahme. iPhone/EAS-Konto sind vorhanden; Apple-Developer-Mitgliedschaft fehlt.
