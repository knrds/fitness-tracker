...
Session-/Template-/Programm-IDs, fertige Session, RPE/RIR, Rest, Dauer, Distanz, Notizen, Supersets und Datumsfelder bleiben bei dieser Speichermigration erhalten. Das Kopieren beim Starten neuer Trainings hat separat noch Paritätslücken (B17). Bekannte Achievement-v1-Daten erhalten repeatCounts ohne XP-Verlust; ISO-Textnotizen bleiben Text.
