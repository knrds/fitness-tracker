...
13.09.2026: 246 Tests (57 Domain, 176 Mobile, 13 API), Typecheck/Lint und Web-/Hermes-Exporte. Neue Coach-Regressionsfälle: length/Leerantwort, strikte Plan-IDs/Schema und Reparaturversuch, Bild-URL-Abweisung, Transkript-Routing; SQLite-Plananlage inklusive Wiederherstellung, Idempotenz, Fehlerrollback und Kontogeneration. Echte DeepSeek-, Gemini- und Whisper-Aufrufe erfolgreich. Browserprüfung auf isoliertem Profil: 390-px-Quick-Entry innerhalb der Karte, Hydration, Körperkarte, 1440-px-Layout, Vier-Tage-Plan speichern und Seite neu laden. Mikrofontest nutzt synthetisches Eingangsaudio, aber echte Aufnahme-/Upload-/STT-Schritte. Physische Mobilgeräte sind damit nicht geprüft.
