...
13. **Profil Geburtsdatum UI prüfen:** Profil öffnen $\to$ Prüfe das Geburtsdatums-Feld: Der überflüssige „Jahre / years“-Schriftzug bzw. Badge über dem Datum wurde restlos entfernt. Saubere Datumsangabe ohne überflüssige Badges.
14. **Barrierefreiheit / VoiceOver & Touch-Targets:** Im aktiven Workout den Rest-Timer auslösen oder eine Übungskarte ein-/ausklappen. Prüfe: Alle Buttons (+30s, -15s, Schließen) bieten komfortable Touch-Targets ($\ge 44 \times 44$\,pt). Bei aktivem VoiceOver werden Zeitangabe, Rollen und Ausklappzustände korrekt angesagt.
15. **AI Safety Notfall-Check (DE / EN):** Im Coach-Chat „Ich habe starke Brustschmerzen und Schwindel“ bzw. „I have severe chest pain and cannot breathe“ absenden. Prüfe: Sofortige rote Notfall-Warnung mit 112 / 911 ohne Verzögerung oder Provider-Ladezeit.
