...
| **Exercise Licensing** | `RESOLVED` | YES (Kostenlose Open-Source-Datenbank `free-exercise-db`) | YES (873 Übungen mit 2-Positionen-Fotos `0.jpg`/`1.jpg`) | YES (ExerciseDB restlos entfernt, keine Kosten/Lizenzblocker) | AR-009 (erledigt) | Keine (Konrad hat ExerciseDB abgelehnt) |
