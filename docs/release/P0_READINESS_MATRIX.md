...
| S3 Authorization / RLS | Versionierte restrictive Guards, korrigierter Harness, echter lokaler PostgreSQL | 304 Assertions; Baseline-Angriff reproduziert; permissive OR-Bypasses und Migrations-Abbruch geprüft | Supabase Auth/PostgREST/Remote-Schema/Grants und reales Deployment | CRITICAL / P0 | Lokalen Vertrag für Sync nutzen; Remote-Abnahme separat, Astra + Nutzer Zugang | PARTIAL |
| S4 Sync / Data Integrity | SQLite/Scope/FIFO, strikte Pull-Validierung, Fehlerweitergabe und lokaler Rollback | 18 neue Regressionen inklusive echter SQLite-Fehlerinjektion | Cloud-Atomizität, Idempotenz, Konflikte, Tombstones, Multi-Device | CRITICAL / P0 | Serverseitigen Transaktionsvertrag ergänzen; Astra | PARTIAL |
...
| S6 AI Production | Serverproxy; öffentlicher Prototyp-Bypass entfernt | 38 API-/Safety-Tests; Auth-Negativfälle vorher rot/jetzt grün, kein Keyfund im Bundle | Server-Pro, verteilte Limits/Budget, Kill Switch, DE/EN Safety; reale Auth-/Hosting-Abnahme | CRITICAL / P0 | Produktionsvertrag vervollständigen; Astra / Nutzer Providerbetrieb | PARTIAL |
...
| Sync | FIFO-Outbox, Retry-Erhalt, Scope; Cloud-Fehler behandelt, Pull vor Anwendung validiert | Failure-Harness wiederverwendet und erweitert | 18 neue Regressionen; kein Multi-Device-Backendtest | CRITICAL | Atomare Cloud-Aggregate, Konflikte/Tombstones, Seeds | PARTIAL |
