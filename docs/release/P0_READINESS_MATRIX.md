...
Aktualisierung 22.09.2026 (Batch 4: Local Foundations, Preferences, Resilience & Taxonomy Wiring, Monetization Integration, Onboarding, A11y, S4 Fixtures, Supply Chain Triage, S5 Deletion, AI Safety DE/EN): Notification Preference Center (07.04) & Local Rest Timer Notifications (07.02) mit striktem Lockscreen-Privacy-Schutz; Contextual Permission Pre-Prompts (06.06); Coach Provider Circuit Breaker (03.10) mit 3-Fehler-Schwelle & Fast-Fail; Remote Config Client Abstraction & Kill Switches (08.04); Support / Feedback Pfad in <= 2 Taps (08.05); Review Prompt Policy (08.06) mit Cooldowns; Large Text Font-Scaling-Schutz (09.05); Core Product Analytics Taxonomy Wiring (08.03). Reale Produktflow-Verdrahtung der 3-Tier-Architektur (FREE/PRO/COACH) mit Store Action Guards. Resiliente Onboarding State Machine (WP-06). **851 Tests grün** (Workspace-Typecheck PASS, Lint PASS, `pnpm build:preview` PASS). S4, S5, serverseitige Quota- und Remote-Infrastruktur für Astra vorbereitet (`ASTRA_REQUIRED`). Keine Production-/Main-Integration, Remote-Migration oder Billing-Aktivierung.
