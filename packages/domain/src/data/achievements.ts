...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'workouts_3', name: 'Three is Company', description: 'Complete 3 workouts', category: 'workouts', targetValue: 3, xpReward: 100, icon: 'fitness' },
  ...
  { id: 'workouts_15', name: 'Fortnight of Iron', description: 'Complete 15 workouts', category: 'workouts', targetValue: 15, xpReward: 250, icon: 'fitness' },
  ...
  { id: 'workouts_75', name: 'Silver Lifter', description: 'Complete 75 workouts', category: 'workouts', targetValue: 75, xpReward: 750, icon: 'shield' },
  ...
  { id: 'streak_5', name: 'High Five', description: 'Maintain a 5-day workout streak', category: 'streaks', targetValue: 5, xpReward: 100, icon: 'flame' },
  ...
  { id: 'streak_21', name: 'Habit Builder', description: 'Maintain a 21-day workout streak', category: 'streaks', targetValue: 21, xpReward: 500, icon: 'flame' },
  ...
  { id: 'prs_3', name: 'Triple Threat', description: 'Achieve 3 personal records', category: 'pr', targetValue: 3, xpReward: 150, icon: 'star' },
  ...
  { id: 'prs_15', name: 'Record Collector', description: 'Achieve 15 personal records', category: 'pr', targetValue: 15, xpReward: 300, icon: 'ribbon' },
  ...
  { id: 'volume_25k', name: 'Heavy Metal', description: 'Lift 25,000 kg of total volume', category: 'volume', targetValue: 25000, xpReward: 350, icon: 'barbell' },
  ...
  { id: 'volume_75k', name: 'Iron Core', description: 'Lift 75,000 kg of total volume', category: 'volume', targetValue: 75000, xpReward: 600, icon: 'barbell' },
  ...
  // ----------------------------------------------------------------------- //
  { id: 'unique_exercises_5', name: 'Variety Starter', description: 'Perform 5 different exercises', category: 'exercises', targetValue: 5, xpReward: 50, icon: 'compass' },
  ...
  { id: 'unique_exercises_20', name: 'Diverse Lifter', description: 'Perform 20 different exercises', category: 'exercises', targetValue: 20, xpReward: 200, icon: 'compass' },
  ...
  // ----------------------------------------------------------------------- //
  { id: 'muscles_3', name: 'Triple Split', description: 'Train 3 different muscle groups', category: 'muscles', targetValue: 3, xpReward: 50, icon: 'body' },
  ...
  { id: 'muscles_7', name: 'Well Rounded Athlete', description: 'Train 7 different muscle groups', category: 'muscles', targetValue: 7, xpReward: 200, icon: 'body' },
